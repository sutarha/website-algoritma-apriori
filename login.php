...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Toko Clothes - MBA Apriori</title>
                        ...
                        <div id="login-box" class="login-box visible widget-box no-border">
                            <div class="widget-body">
                                ...
                                ?>
                                    ...
                                    <div class="col-sm-6">
                                        <h1>
                                            Aplikasi MBA Algoritma Apriori
                                        </h1>
                                        <p class="lead">
                                            Implementasi Market Basket Analisis data Mining Rule Asosiasi Menggunakan Algoritma Apriori dalam Penentuan Pola Transaksi (Studi Kasus: Toko Clothes)
                                        </p>
                                    </div>
                                    <div class="col-sm-6">
